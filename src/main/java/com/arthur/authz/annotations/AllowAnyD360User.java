...
@PreAuthorize("hasAuthority(T(com.arthur.authz.Permission).D360_TV_ENTERPRISE.getValue()) "
    ...
    + "or hasAuthority(T(com.arthur.authz.Permission).D360_TALENT_LITE.getValue()) "
    + "or hasAuthority(T(com.arthur.authz.Permission).D360_MOVIE_LITE.getValue()) "
    + "or hasAuthority(T(com.arthur.authz.Permission).D360_TV_LITE.getValue()) "
)
public @interface AllowAnyD360User {
